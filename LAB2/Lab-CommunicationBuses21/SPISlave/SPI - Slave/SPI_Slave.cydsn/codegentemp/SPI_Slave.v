...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("957bc723-e13a-4e96-bb63-f90de73ab70c"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9757c039-ada4-4ce9-bfb1-20934a5c23a7"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("08696fb8-2348-4459-903d-a5d21f4da36d"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("82a6073b-c76a-44aa-9644-6561c2e9a9e6"),
		  .source_clock_id(""),
		  .divisor(0),
