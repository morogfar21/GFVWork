...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("3a14fa0c-f762-4956-8211-4fcf8e5a4bde"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_LN1_net;
	wire [0:0] tmpFB_0__Pin_LN1_net;
	wire [0:0] tmpIO_0__Pin_LN1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_LN1_net;
	electrical [0:0] tmpSIOVREF__Pin_LN1_net;

	cy_psoc3_pins_v1_10
		#(.id("2a76b75b-a257-4cca-971f-df7ad3359cb7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_LN1
		 (.oe(tmpOE__Pin_LN1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_LN1_net[0:0]}),
		  .io({tmpIO_0__Pin_LN1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_LN1_net),
		  .interrupt({tmpINTERRUPT_0__Pin_LN1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_LN1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_LN2_net;
	wire [0:0] tmpFB_0__Pin_LN2_net;
	wire [0:0] tmpIO_0__Pin_LN2_net;
	wire [0:0] tmpINTERRUPT_0__Pin_LN2_net;
	electrical [0:0] tmpSIOVREF__Pin_LN2_net;

	cy_psoc3_pins_v1_10
		#(.id("91167268-d028-4b88-9c3e-5ff6dae8dcdb"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_LN2
		 (.oe(tmpOE__Pin_LN2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_LN2_net[0:0]}),
		  .io({tmpIO_0__Pin_LN2_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_LN2_net),
		  .interrupt({tmpINTERRUPT_0__Pin_LN2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_LN2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_EN2_net;
	wire [0:0] tmpFB_0__Pin_EN2_net;
	wire [0:0] tmpIO_0__Pin_EN2_net;
	wire [0:0] tmpINTERRUPT_0__Pin_EN2_net;
	electrical [0:0] tmpSIOVREF__Pin_EN2_net;

	cy_psoc3_pins_v1_10
		#(.id("a7dac33c-a1a0-43a0-9197-4b2f53353576"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_EN2
		 (.oe(tmpOE__Pin_EN2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_EN2_net[0:0]}),
		  .io({tmpIO_0__Pin_EN2_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_EN2_net),
		  .interrupt({tmpINTERRUPT_0__Pin_EN2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_EN2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_2A_net;
	wire [0:0] tmpFB_0__Pin_2A_net;
	wire [0:0] tmpIO_0__Pin_2A_net;
	wire [0:0] tmpINTERRUPT_0__Pin_2A_net;
	electrical [0:0] tmpSIOVREF__Pin_2A_net;

	cy_psoc3_pins_v1_10
		#(.id("67fef5e4-9c18-4058-94eb-0cc31baa8496"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_2A
		 (.oe(tmpOE__Pin_2A_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_2A_net[0:0]}),
		  .io({tmpIO_0__Pin_2A_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_2A_net),
		  .interrupt({tmpINTERRUPT_0__Pin_2A_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_2A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("955cbbb7-adc6-4268-b335-861df92bcd17"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_2B_net;
	wire [0:0] tmpFB_0__Pin_2B_net;
	wire [0:0] tmpIO_0__Pin_2B_net;
	wire [0:0] tmpINTERRUPT_0__Pin_2B_net;
	electrical [0:0] tmpSIOVREF__Pin_2B_net;

	cy_psoc3_pins_v1_10
		#(.id("857f6443-317f-4a81-9728-3754404279f2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_2B
		 (.oe(tmpOE__Pin_2B_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_2B_net[0:0]}),
		  .io({tmpIO_0__Pin_2B_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_2B_net),
		  .interrupt({tmpINTERRUPT_0__Pin_2B_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_2B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_LN3_net;
	wire [0:0] tmpFB_0__Pin_LN3_net;
	wire [0:0] tmpIO_0__Pin_LN3_net;
	wire [0:0] tmpINTERRUPT_0__Pin_LN3_net;
	electrical [0:0] tmpSIOVREF__Pin_LN3_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_LN3
		 (.oe(tmpOE__Pin_LN3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_LN3_net[0:0]}),
		  .io({tmpIO_0__Pin_LN3_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_LN3_net),
		  .interrupt({tmpINTERRUPT_0__Pin_LN3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_LN3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_LN4_net;
	wire [0:0] tmpFB_0__Pin_LN4_net;
	wire [0:0] tmpIO_0__Pin_LN4_net;
	wire [0:0] tmpINTERRUPT_0__Pin_LN4_net;
	electrical [0:0] tmpSIOVREF__Pin_LN4_net;

	cy_psoc3_pins_v1_10
		#(.id("f4045ff3-a935-47fe-a693-d7889e3cb0f4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_LN4
		 (.oe(tmpOE__Pin_LN4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_LN4_net[0:0]}),
		  .io({tmpIO_0__Pin_LN4_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_LN4_net),
		  .interrupt({tmpINTERRUPT_0__Pin_LN4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_LN4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
